/*
 * juncao_marotation_pwm_codigo_limpo.c
 *
...
/*
	Faz diferença entre dois pulsos do ímã, contando através da variavel counter 
*/
...
ISR(PCINT1_vect) {						//detecta troca de estado em portas C
	...
	if(deadman == 0) //( PINC & (1 << PINC3) )  //detecta LOW em PC3, que é o deadman button
	{
